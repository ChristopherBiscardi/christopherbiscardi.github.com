...
I currently use Netlify CMS to edit my blog posts and I'm starting to
feel the need for something a bit more custom. Currently, Netlify CMS
will blow away the `featuredImage` key on updates, erasing the Twitter
opengraph image from being presented.
