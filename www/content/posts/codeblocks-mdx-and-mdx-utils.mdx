...
> Note: Since the publishing of this post, MDX has hit 1.0. In 1.0 we removed the intermediary `MDXTag` component mentioned here in favor of [a custom pragma](https://mdxjs.com/blog/custom-pragma/). This simplifies `preToCodeProps` so while the description of that function here is still conceptually accurate, it is no longer literally accurate.
