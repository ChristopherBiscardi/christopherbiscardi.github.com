---
title:
  "Installing Montage: A Riak sibling resolution library
  written in Haskell, on OSX"
date: 2013-07-26
slug: "/2013/7/25/installing-montage-a-riak-sibling-resolution-library-written-in-haskell-on-osx/"
---

Here is a description of how I installed Montage
(https://github.com/bumptech/montage) with GHC 7.6.1

First clone these repos (the relevant commit I used is
listed below each clone command)
