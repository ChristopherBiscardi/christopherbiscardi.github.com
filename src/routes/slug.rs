        ...
        match content_resource.await.to_owned() {
            Ok(Ok(content)) => {
                Ok(view! {
                    ...
                    <Meta property="og:url" content=format!("https://christopherbiscardi.com/{}", content.meta.slug.unwrap_or("unknown".to_string()))/>
                    <Meta
                        property="og:image"
...
pub fn Hero(
    ...
    <div class="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
                    ...
                    <p class="mt-6 text-xl text-sky-100 max-w-3xl">{byline}</p>
                </div>
                </div>
        }
}
