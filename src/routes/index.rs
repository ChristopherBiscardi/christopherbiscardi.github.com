...
pub fn IndexPage() -> impl IntoView {
    ...
    view! {
        ...
        <Meta
            name="description"
            content="Chris Biscardi is an independent Software Engineer specializing in Rust and JavaScript, programming communicator, educator, and a YouTuber"
        />

        <Link rel="canonical" href="https://christopherbiscardi.com"/>
        <Meta property="og:type" content="website"/>
        <Meta property="og:url" content="https://christopherbiscardi.com"/>
        <Meta
            property="og:image"
        ...
        >
            <div class="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
                ...
                <p class="mt-6 text-xl text-indigo-100 max-w-3xl">
                    ...
                    <a class="font-bold text-red-400" href="/rust">Rust</a> and
                    <span class="font-bold text-[#EAD54D]">JavaScript</span>, programming communicator, educator, and a
                    <a href="https://www.youtube.com/@chrisbiscardi" class="font-bold text-[#ff0000]">YouTuber</a>.
                </p>
                <p class="mt-6 text-large text-indigo-100 max-w-3xl">
                    I maintain <a href="https://www.rustadventure.dev/" class="font-bold text-red-400">Rust Adventure</a>:
                    a collection of workshops and practical projects you can use to learn Rust
                    and <a href="https://thisweekinbevy.com/" class="font-bold text-sky-400">This Week in Bevy</a>,
                ...
                <p class="mt-6 text-large text-indigo-100 max-w-3xl">
                    This site is built with <a href="" class="font-bold text-[#F04948]">Leptos</a> and
                    <a href="" class="font-bold text-[#a598f6]">Wasm</a>.
                </p>
