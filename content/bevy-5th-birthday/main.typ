...
#metadata((
  ...
  "image_url": "/opengraph/bevy-5th-birthday.webp","published": "2025-09-11"
)) <frontmatter>
...
I still think this is a valuable workflow that deserves a solution, so I started experimenting with the workflow #link("https://youtube.com/live/mUYnvt68vNA")[from scratch] on Saturday's live streams and produced some #link("https://youtu.be/HfQatgUyFYc")[educational content] showing off how Blender's custom properties worked and how you could programatically consume them in Bevy.

As I worked, I kept in mind some aspects of Blenvy that I had seen
people have difficulty with, and that I thought could be reworked. I
didn't really intend to replace Blenvy at first, it was originally a
knowledge-gathering quest.

One of the issues the community had with maintaining Blenvy was the amount of code involved: approximately 10,000 lines of python and 7k lines of Rust (stats generated from running tokei) Skein, by comparison, is about 2,000 lines of python and 300 lines of Rust.
...
Firstly I want to make an example game roughly based on Tunic. It can be
hard to imagine a workflow with tools you're unfamiliar with, and
Blender is one of those "oh I should learn that someday" tools for many
people. Tunic is a particularly good 3d game target for a demo because
of the way it uses features like vertex painting and because the
modelling and approach was done by a game developer who was learning
modelling as they went. I think the author of Tunic was in a similar
place to the current userbase that will be looking at Skein as a tool,
and a "clone-ish" game will show off some nice integration points.
