...
This gives us a nice graphiql interface to make some test queries. Since I set up webmentions with [brid.gy](https://brid.gy/) to pull in Tweets as mentions, I can filter likes out using `ne: 'like-of' and filter for only the page I'm currently showing using `wmTarget`.
