...
We can then impor the `mq` function or pass it through context in our theme. The following example changes the color based on the media query using an array syntax for values.
